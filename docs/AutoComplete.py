...
class CUO:
	...
	@staticmethod
	def Following() -> "ValueTuple[Boolean, UInt32]":
...
class Gumps:
	...
	@staticmethod
	def AddButton(gd: "Gumps.GumpData&@", x: int, y: int, normalID: int, pressedID: int, buttonID: int, type: int, param: int):
		"""
	...
	@staticmethod
	def AddCheck(gd: "Gumps.GumpData&@", x: int, y: int, inactiveID: int, activeID: int, initialState: bool, switchID: int):
		"""
	...
	@staticmethod
	def AddHtml(gd: "Gumps.GumpData&@", x: int, y: int, width: int, height: int, text: Union[str, int], background: bool, scrollbar: bool):
		"""
	...
	@staticmethod
	def AddHtmlLocalized(gd: "Gumps.GumpData&@", x: int, y: int, width: int, height: int, number: int, args: Union[str, int, bool], color: Union[int, bool], background: Union[bool, None] = None, scrollbar: Union[bool, None] = None):
		"""
	...
	@staticmethod
	def AddImageTiledButton(gd: "Gumps.GumpData&@", x: int, y: int, normalID: int, pressedID: int, buttonID: int, type: "Gumps.GumpButtonType", param: int, itemID: int, hue: int, width: int, height: int, localizedTooltip: Union[int, None] = None):
		"""
	...
	@staticmethod
	def AddLabelCropped(gd: "Gumps.GumpData&@", x: int, y: int, width: int, height: int, hue: int, text: Union[str, int]):
		"""
	...
	@staticmethod
	def AddRadio(gd: "Gumps.GumpData&@", x: int, y: int, inactiveID: int, activeID: int, initialState: bool, switchID: int):
		"""
	...
	@staticmethod
	def AddSpriteImage(gd: "Gumps.GumpData&@", x: int, y: int, gumpId: int, spriteX: int, spriteY: int, spriteW: int, spriteH: int):
		"""
	...
	@staticmethod
	def AddTextEntry(gd: "Gumps.GumpData&@", x: int, y: int, width: int, height: int, hue: int, entryID: int, initialTextID: Union[int, str]):
		"""
	...
	@staticmethod
	def CreateGump(movable: bool, closable: bool, disposable: bool, resizeable: bool) -> "Gumps.GumpData":
	...
	@staticmethod
	def SendAdvancedAction(gumpid: "UInt32", buttonid: int, switchlist_id: Union["PythonList", "List[Int32]"], textlist_id: Union["PythonList", "List[Int32]", "List[String]", None] = None, textlist_str: Union["PythonList", "List[String]", None] = None):
	...
	@staticmethod
	def SendGump(gumpid: Union["UInt32", "Gumps.GumpData"], serial: "UInt32", x: "UInt32", y: Union["UInt32", None] = None, gumpDefinition: Union[str, None] = None, gumpStrings: Union["List[String]", None] = None):
		"""
...
class Items:
	...
	@staticmethod
	def FindAllByID(itemids: Union["PythonList", int, "List[Int32]"], color: int, container: int, range: int, considerIgnoreList: bool) -> Union["PythonList", "List[Item]"]:
	...
	@staticmethod
	def FindByID(itemids: Union["List[Int32]", int], color: int, container: int, range: Union[int, bool], considerIgnoreList: bool) -> "Item":
	...
	@staticmethod
	def FindByName(itemName: str, color: int, container: int, range: int, considerIgnoreList: bool) -> "Item":
	...
	@staticmethod
	def GetWeaponAbility(itemId: int) -> "ValueTuple[String, String]":
	...
	@staticmethod
	def IgnoreTypes(itemIdList: "PythonList"):
	...
	@staticmethod
	def Move(source: Union["Item", int], destination: Union["Mobile", int, "Item"], amount: int, x: Union[int, None] = None, y: Union[int, None] = None):
		"""
	...
	@staticmethod
	def UseItem(itemSerial: Union[int, "Item"], targetSerial: Union[int, "UOEntity", None] = None, wait: Union[bool, None] = None):
...
class Journal:
	...
	def Clear(self, toBeRemoved: Union[str, None] = None):
	...
	def GetJournalEntry(self, afterTimestap: Union[float, "Journal.JournalEntry"]) -> "List[Journal.JournalEntry]":
	...
	def GetLineText(self, text: str, addname: bool) -> str:
	...
	def GetSpeechName(self) -> "List[String]":
	...
	def GetTextByColor(self, color: int, addname: bool) -> "List[String]":
	...
	def GetTextByName(self, name: str, addname: bool) -> "List[String]":
	...
	def GetTextBySerial(self, serial: int, addname: bool) -> "List[String]":
	...
	def GetTextByType(self, type: str, addname: bool) -> "List[String]":
	...
	def RemoveFilterText(self, text: str):
	...
	def SearchByColor(self, text: str, color: int) -> bool:
	...
	def SearchByName(self, text: str, name: str) -> bool:
	...
	def SearchByType(self, text: str, type: str) -> bool:
	...
	def WaitByName(self, name: str, delay: int) -> bool:
	...
	def WaitJournal(self, text: Union[str, "List[String]"], delay: int) -> Union[bool, str]:
...
class Misc:
	...
	@staticmethod
	def SendMessage(msg: Union[str, float, object, int, "UInt32", bool, float], color: Union[int, bool, None] = None, wait: Union[bool, None] = None):
...
class Mobiles:
	...
	@staticmethod
	def FindMobile(graphics: Union["List[Int32]", int], notoriety: "List[Byte]", rangemax: int, selector: str, highlight: bool) -> "Mobile":
		"""
...
class PacketLogger:
	...
	@staticmethod
	def ListenPacketPath(packetPath: str, active: bool) -> "String[][]":
		"""Packet logger will discard all packets, except the one in the whitelist.  (See PacketLogger.AddWhitelist() ) 
	...
	@staticmethod
	def SendToClient(packetData: Union["PythonList", "List[Byte]", "Byte[][]"]):
	...
	@staticmethod
	def SendToServer(packetData: Union["PythonList", "List[Byte]", "Byte[][]"]):
		"""
...
class Player:
	...
	@staticmethod
	def AttackType(graphics: Union["List[Int32]", int], rangemax: int, selector: str, color: "List[Int32]", notoriety: "List[Byte]") -> bool:
		"""
	...
	@staticmethod
	def EquipUO3D(serials: Union["List[Int32]", "PythonList"]):
	...
	@staticmethod
	def UnEquipUO3D(_layers: Union["List[String]", "PythonList"]):
		"""
	...
	@staticmethod
	def UseSkill(skillname: str, target: Union["Mobile", "Item", int, bool, None] = None, wait: Union[bool, None] = None):
...
class Spells:
	...
	@staticmethod
	def Cast(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastChivalry(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastCleric(SpellName: str, mobile: Union["Mobile", "UInt32", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastDruid(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastMagery(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastMastery(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastMysticism(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastNecro(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
	...
	@staticmethod
	def CastNinjitsu(SpellName: str, mobile: Union["Mobile", "UInt32", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
		"""
	...
	@staticmethod
	def CastSpellweaving(SpellName: str, target: Union["UInt32", "Mobile", int], wait: Union[bool, None] = None, waitAfter: Union[int, None] = None):
...
class Target:
	...
	@staticmethod
	def TargetExecute(x: Union[int, "UOEntity"], y: Union[int, None] = None, z: Union[int, None] = None, StaticID: Union[int, None] = None):
...
class Trade:
	...
	@staticmethod
	def Offer(TradeID: int, gold: int, platinum: Union[int, bool], quiet: Union[bool, None] = None) -> bool:
